...
- [✅ Функционал сервиса](#functional-servise)
...
<h2 id="osobennosti">🌟 Особенности [🔝](#table-of-contents)</h2>
...
<h2 id="functional-servise">✅ Функционал сервиса [🔝](#table-of-contents)</h2>
...
<h2 id="komponenty-sistemy">📦 Компоненты системы [🔝](#table-of-contents)</h2>


<h3 id="klaster-mongodb">🍔 Кластер MongoDB [🔝](#komponenty-sistemy)</h3>
...
<h3 id="klaster-clickhouse">🍔 Кластер Clickhouse [🔝](#komponenty-sistemy)</h3>
...
<h3 id="klaster-kafka">🍔 Кластер Kafka [🔝](#komponenty-sistemy)</h3>
...
<h2 id="chistaya-architektura">🛁 Чистая архитектура [🔝](#table-of-contents)</h2>
...
<h2 id="bystryi-start">Быстрый старт [🔝](#table-of-contents)</h2>
...
<h3 id="nastroyka-peremennyh-okruzheniya">Настройка переменных окружения [🔝](#bystryi-start)</h3>
...
<h3 id="bystryi-zapusk-proekta">Запуск проекта</h3>
...
<h2 id="rezhim-razrabotki">👉 Режим разработки [🔝](#table-of-contents)</h2>


<h3 id="prerequirements">Pre requirements [🔝](#rezhim-razrabotki)</h3>
...
<h3 id="sozdanie-sredy-razrabotki">Создание среды разработки [🔝](#rezhim-razrabotki)</h3>
...
<h3 id="peremennye-okruzheniya">Переменные окружения [🔝](#rezhim-razrabotki)</h3>
...
<h3 id="ustanovit-poetry">Установить Poetry [🔝](#rezhim-razrabotki)</h3>
...
<h3 id="podrobnee-pro-docker">Подробнее про Docker [🔝](#rezhim-razrabotki)</h3>
...
<h4 id="docker-compose-yml">Файл docker-compose.yml [🔝](#rezhim-razrabotki)</h4>
...
<h4 id="profiles">Профили [🔝](#rezhim-razrabotki)</h4>
...
<h4 id="docker-compose-dev-yml">Файл docker-compose.dev.yml [🔝](#rezhim-razrabotki)</h4>
...
<h4 id="docker-compose-test-yml">Файл docker-compose.test.yml [🔝](#rezhim-razrabotki)</h4>

Файл `docker-compose.test.yml` содержит сервисы только для тестов. Этот файл используется для запуска
тестов в докере.


<h3 id="rezhimy-zapuska">Режимы запуска [🔝](#rezhim-razrabotki)</h3>
...
<h3 id="odin-dockerfile-dlya-dvukh-rezhimov">Один Dockerfile для двух режимов [🔝](#rezhim-razrabotki)</h3>
...
<h3 id="essential-services">Essential services [🔝](#rezhim-razrabotki)</h3>
...
<h3 id="zapusk-proekta">Запуск проекта [🔝](#rezhim-razrabotki)</h3>
...
<h3 id="poleznye-komandy">Полезные команды [🔝](#rezhim-razrabotki)</h3>
...
<h3 id="localnyi-zapusk">Локальный запуск [🔝](#rezhim-razrabotki)</h3>
...
<h2 id="osobennosti-razrabotki">👉 Особенности разработки [🔝](#table-of-contents)</h2>
...
<h3 id="conventional-commits">Conventional Commits [🔝](#osobennosti-razrabotki)</h3>
...
<h3 id="nastroyki-ide">Настройки IDE [🔝](#osobennosti-razrabotki)</h3>
...
<h3 id="formatter-i-linter">Форматер и линтер [🔝](#osobennosti-razrabotki)</h3>
