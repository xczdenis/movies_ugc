...
<h3 id="klaster-mongodb">Кластер MongoDB</h3>
...
<h3 id="klaster-clickhouse">Кластер Clickhouse</h3>
...
<h3 id="klaster-kafka">Кластер Kafka</h3>
...
<h2 id="chistaya-architektura">Чистая архитектура</h2>
...
<h2 id="bystryi start">Быстрый старт</h2>
...
<h3 id="nastroyka-peremennyh-okruzheniya">Настройка переменных окружения</h3>
...
<h2 id="rezhim-razrabotki">Режим разработки</h2>
...
<h3 id="sozdanie-sredy-razrabotki">Создание среды разработки</h3>
...
<h3 id="peremennye-okruzheniya">Переменные окружения</h3>
...
<h3 id="ustanovit-poetry">Установить Poetry</h3>
...
<h3 id="podrobnee-pro-docker">Подробнее про Docker</h3>
...
<h4 id="docker-compose-yml">Файл docker-compose.yml</h4>
...
<h4 id="docker-compose-dev-yml">Файл docker-compose.dev.yml</h4>
...
<h4 id="docker-compose-test-yml">Файл docker-compose.test.yml</h4>

Файл `docker-compose.test.yml` содержит сервисы только для тестов. Этот файл используется для запуска
тестов в докере.


<h3 id="rezhimy-zapuska">Режимы запуска</h3>
...
<h3 id="odin-dockerfile-dlya-dvukh-rezhimov">Один Dockerfile для двух режимов</h3>
...
<h3 id="zapusk-proekta">Запуск проекта</h3>
...
<h3 id="poleznye-komandy">Полезные команды</h3>
...
<h3 id="localnyi-zapusk">Локальный запуск</h3>
...
<h2 id="osobennosti-razrabotki">Особенности разработки</h2>
...
<h3 id="upravlenie-zavisimostyami">Управление зависимостями</h3>
...
<h3 id="nastroyki-ide">Настройки IDE</h3>
...
<h3 id="formatter-i-linter">Форматер и линтер</h3>
